...
> [!TIP]
> We have many ways to run powershell in Windows 11. [^1]
...
### Step 3  
Now, after a short delay to allow it to run, please copy the following line
...
### The following is the list of Windows 11 LICENSE KEYS  
...
> [!NOTE]
> Please choose a **license key** from the list that matches your **edition of Windows**, and replace XXXXX-XXXXX-XXXXX-XXXXX-XXXXX in the command with the one you selected.
...
The last step is to activate your Windows 11 using the command:
